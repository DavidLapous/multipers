...
class Cubical_complex_interface : public Bitmap_cubical_complex<Bitmap_cubical_complex_base<double>> {
  typedef Bitmap_cubical_complex<Bitmap_cubical_complex_base<multi_filtrations::Finitely_critical_multi_filtration<float>>> Base;
 public:
...
//   typedef Bitmap_cubical_complex<Bitmap_cubical_complex_periodic_boundary_conditions_base<multi_filtrations::Finitely_critical_multi_filtration<float>>> Base;
//  public:
//   using Base::Base; // inheriting constructors
//   // using Base::data;
