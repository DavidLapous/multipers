...
enum Filtration_containers_strs : std::uint8_t { Nested_container, Flat_container, Degree_rips };
...
using MatrixBackendNoVine =
    Gudhi::multi_persistence::Persistence_interface_homology<BackendOptionsWithoutVine<col>, Filtration>;

template <Available_columns col>
using MatrixBackendVine =
    Gudhi::multi_persistence::Persistence_interface_vineyard<Multi_persistence_vineyard_ru_options<col>>;

template <Available_columns col>
using ClementMatrixBackendVine =
    Gudhi::multi_persistence::Persistence_interface_vineyard<Multi_persistence_vineyard_chain_options<col>>;
...
template <typename T, bool Co = false, bool OneCritical = false>
using Degree_rips_bifiltration = Gudhi::multi_filtration::
    Multi_parameter_filtration_value<Gudhi::multi_filtration::Degree_bifiltration<T>, Co, OneCritical>;
template <typename T, bool Co = false, bool OneCritical = false>
using Dynamic_multi_parameter_filtration = Gudhi::multi_filtration::
    Multi_parameter_filtration_value<Gudhi::multi_filtration::Nested_array_filtration<T>, Co, OneCritical>;
template <typename T, bool Co = false, bool OneCritical = false>
using Multi_parameter_filtration = Gudhi::multi_filtration::
    Multi_parameter_filtration_value<Gudhi::multi_filtration::Flat_array_filtration<T>, Co, OneCritical>;

template <typename value_type = float>
using Filtration_value = Multi_parameter_filtration<value_type, false, true>;

template <class Filtration, Available_columns col = Available_columns::INTRUSIVE_SET>
using SimplicialNoVineMatrixTruc =
    Gudhi::multi_persistence::Slicer<Filtration_value<>, MatrixBackendNoVine<col, Filtration>>;
...
// multi-critical
template <typename value_type = float>
using Multi_critical_filtration_value = Multi_parameter_filtration<value_type>;
...
using filtration_options =
    std::conditional_t<fil_container == Filtration_containers_strs::Nested_container,
                       Dynamic_multi_parameter_filtration<value_type, false, !is_k_critical>,
                       std::conditional_t<fil_container == Filtration_containers_strs::Flat_container,
                                          Multi_parameter_filtration<value_type, false, !is_k_critical>,
                                          Degree_rips_bifiltration<value_type, false, !is_k_critical>>>;
...
template <BackendsEnum backend,
          ...
          typename value_type,
          Available_columns col = Available_columns::INTRUSIVE_SET,
          Filtration_containers_strs filt_cont = Filtration_containers_strs::Flat_container>
...
// for python
template <typename T>
using One_critical_filtration = Multi_parameter_filtration<T, false, true>;
template <typename T>
using Multi_critical_filtration = Multi_parameter_filtration<T, false, false>;
